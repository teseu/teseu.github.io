<template>
  <svg width="100%" height="100%" viewBox="0 0 40 40" version="1.1" sodipodi:docname="vapor-svgrepo-com-pb.svg"
    fill="currentColor">
    <sodipodi:namedview id="namedview1" />
    <defs id="defs7" />
    <title id="title1">Teseu's vaporHole</title>
    <path
    ...
    <metadata id="metadata7">
      <rdf:RDF>
        <cc:Work rdf:about="">
          <dc:title>Teseu's vaporHole</dc:title>
        </cc:Work>
      </rdf:RDF>
    </metadata>
  </svg>
